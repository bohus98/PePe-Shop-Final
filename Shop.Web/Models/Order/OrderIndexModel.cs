...
namespace Shop.Web.Models.Order
{
	public class OrderIndexModel
	{
        ...
        [Required(ErrorMessage = "Prosim, zadajte Vasu adresu")]
		[StringLength(100)]
		[Display(Name = "Adresa")]
		public string Address { get; set; }

		[Required(ErrorMessage = "Prosim, zadajte Vase PSC")]
		[Display(Name = "PSC")]
		[StringLength(10, MinimumLength = 4)]
		public string ZipCode { get; set; }

		[Required(ErrorMessage = "Prosim, zadajte Vasu krajinu")]
		[StringLength(50)]
		public string Country { get; set; }

        [Required(ErrorMessage = "Prosim, zadajte Vase mesto")]
        [StringLength(50)]
